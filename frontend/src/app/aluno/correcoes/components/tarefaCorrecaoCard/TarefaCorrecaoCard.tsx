...
import { LuFilePenLine, LuBook, LuCopyCheck, LuClock9, LuUser } from 'react-icons/lu';
    ...
    >
      ...
      <div className={styles.infoContainer}>
        <div className={styles.infoMateria}>
          ...
          <span>{tarefa.tipo === 'QUESTIONARIO' ? 'Questionário' : tarefa.tipo === 'PROVA' ? 'Prova' : 'Trabalho'}</span>
        </div>
        <h2>{tarefa.titulo}</h2>
